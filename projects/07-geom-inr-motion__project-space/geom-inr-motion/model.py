...
Key Features:
- SIREN-style initialization for sine activations (using shared implicit_fields library)
...
from implicit_fields import SineActivation as Sine, SirenLayer as SIRENLayer
